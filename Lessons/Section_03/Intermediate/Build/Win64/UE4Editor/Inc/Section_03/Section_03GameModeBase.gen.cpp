...
void EmptyLinkFunctionForGeneratedCodeSection_03GameModeBase() {}
// Cross Module References
	SECTION_03_API UClass* Z_Construct_UClass_ASection_03GameModeBase_NoRegister();
	SECTION_03_API UClass* Z_Construct_UClass_ASection_03GameModeBase();
...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_ASection_03GameModeBase()
	{
		...
		if (!OuterClass)
		{
			static UObject* (*const DependentSingletons[])() = {
				...
				(UObject* (*)())Z_Construct_UPackage__Script_Section_03,
			};
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam Class_MetaDataParams[] = {
				{ "HideCategories", "Info Rendering MovementReplication Replication Actor Input Movement Collision Rendering Utilities|Transformation" },
				{ "IncludePath", "Section_03GameModeBase.h" },
				{ "ModuleRelativePath", "Section_03GameModeBase.h" },
				{ "ShowCategories", "Input|MouseInput Input|TouchInput" },
			};
#endif
			static const FCppClassTypeInfoStatic StaticCppClassTypeInfo = {
				TCppClassTypeTraits<ASection_03GameModeBase>::IsAbstract,
			};
			static const UE4CodeGen_Private::FClassParams ClassParams = {
				&ASection_03GameModeBase::StaticClass,
	...
	IMPLEMENT_CLASS(ASection_03GameModeBase, 2045491879);
